                    ...
                    <form className={`relative space-y-6 w-[100%]  z-10 `} >
...

                        {
                            data.transporte === 'Maritimo' && <>
                                <InputFlotante type="number" id="floating_5" onChange={onChangeHandler} ref={inputRef4} defaultValue={data['Costo Transporte Terrestre Puerto']} required label={`Costo Transporte Terrestre Puerto`} />
                            </>
                        }
